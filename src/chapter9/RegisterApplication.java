...
// public class RegisterApplication extends JFrame implements ActionListener{ // extends คือการสืบทอดคุณสมบัติจากคลาส JFrame  implements คือการสัญญาว่าคลาสนี้จะมีเมธอดที่ระบุใน ActionListener
//     Student std[];
//     Subject sub[];
...
//         super(">>>   Program Register   <<<"); // สามารถเรียก super("ชื่อโปรแกรม") เพื่อตั้งชื่อหน้าต่าง
...
public class RegisterApplication extends JFrame implements ActionListener{ // extends คือการสืบทอดคุณสมบัติจากคลาส JFrame  implements คือการสัญญาว่าคลาสนี้จะมีเมธอดที่ระบุใน ActionListener
    ...
    public void guiStd() {
        ...
        panelStd.add(addstdBtn);
        stdText = new JTextField(45);
        stdText.setHorizontalAlignment(JTextField.CENTER);
        stdText.setEditable(false);
        panelStd.add(stdText);
        container.add(panelStd);
    }
