...
public class AppProduct extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        if (event.getSource() == btnSave) {
            try {
                ...
                writer.write(textCode.getText() + "," + textName.getText() + "," + textPrice.getText() + "\n");
                writer.close();
            } catch (IOException e) {
    ...
    public void initGui() {
        ...
        c.add(new JLabel("Enter Product Code :     "));
        c.add(textCode = new JTextField(10));
        c.add(new JLabel("Enter Product Name :    "));
        c.add(textName = new JTextField(10));
        c.add(new JLabel("Enter Product Price :     "));
        c.add(textPrice = new JTextField(10));
        c.add(btnSave = new JButton("Save Product")); btnSave.addActionListener(this);
        c.add(btnRead = new JButton("Read Product")); btnRead.addActionListener(this);
        c.add(scrollPane = new JScrollPane(textArea = new JTextArea(8,22)));
    }
}