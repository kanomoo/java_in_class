...
class AppReadWriteFile extends JFrame implements ActionListener {
    JPanel panel;
    JTextField textField;
    JLabel label;
    JTextArea outputArea;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try {
            ...
            JOptionPane.showInputDialog(this, "can not open file " + filename, "Error message", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public AppReadWriteFile() {
        ...
        panel.setPreferredSize(new Dimension(500, 70));
        panel.add(label = new JLabel("Enter file name : ")); label.setFont(myFont);
        panel.add(textField = new JTextField(16)); textField.addActionListener(this); textField.setFont(myFont);
        c.add(panel);
        c.add(scrollPane = new JScrollPane(outputArea = new JTextArea(12,30))); outputArea.setEditable(false); outputArea.setFont(myFont);
        setSize(600,400);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setVisible(true);
    }
