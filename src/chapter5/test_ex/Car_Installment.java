...
public class Car_Installment {
    ...
    public void start() {
        while (true) {
            ...
            if (choice.equals("0")) {
                JOptionPane.showMessageDialog(null, "Exit program...", "Error Message", JOptionPane.ERROR_MESSAGE);
                System.exit(0);
            }
            else if (choice.equals("1"))
                price = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter car price : "));
            else if (choice.equals("2"))
                downPayment = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter down payment(%) : "));
            else if (choice.equals("3"))
                interestRate = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter interest rate(%) per year : "));
